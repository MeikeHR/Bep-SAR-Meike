...
params = {
    ...
    "search_pattern": UserSettableParameter('choice', "Zoekpatroon", value='Parallel Sweep',
                                            choices=['Parallel Sweep',
                                                     ...
                                                     'Sector Search',
                                                     'Random Search']),
    "wind_richting": UserSettableParameter('choice', "Wind richting", value='OOST',
                                           choices=['OOST',
                                                    'WEST',
                                                    'ZUID',
                                                    'NOORD']),
    ...
    "upper_current": UserSettableParameter("slider", "Upper current, northern direction (m/s)", 0.41, 0.41, 0.77, 0.01),
