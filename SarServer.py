...
params = {
    ...
    "search_pattern": UserSettableParameter('choice', "Zoekpatroon", value='Parallel Sweep',
                                            choices=['Parallel Sweep',
                                                     ...
                                                     'Sector Search',
                                                     'Random Search']),
    "wind_richting": UserSettableParameter('choice', "Windrichting", value='OOST',
                                           choices=['OOST',
                                                    'WEST',
                                                    'ZUID',
                                                    'NOORD']),
    "swimming_ability": UserSettableParameter('choice', "Zwemvaardigheid", value='GOED',
                                           choices=['GOED',
                                                    'SLECHT']),
    # "max_current": UserSettableParameter("slider", "Maximum current in riptide (m/s)", 2, 1, 2.5, 0.5),
    "upper_current": UserSettableParameter("slider", "Stroming Noordzee (m/s)", 0.41, 0.41, 0.77, 0.01),
    # "search_radius": UserSettableParameter("slider", "Search radius (m)", 100, 50, 125, 25),
    "wind": UserSettableParameter("slider", "Windsnelheid (m/s)", 8, 8, 10, 1),
    "profile": UserSettableParameter("slider", "Kennisprofiel (-)", 1, 1, 2, 1),
